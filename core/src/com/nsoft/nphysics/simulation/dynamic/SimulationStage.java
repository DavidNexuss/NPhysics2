...
/**
 * Fase encarregada de la simulaci� din�mica del programa.
 * Es el node central al que tots els elements d'aquesta fase
 * s'afegeixen.
 * 
 * Cont� l'objecte World i les llistes dels objectes.
 * Tamb� permet l'utilitzaci� no gr�fica de les seves instruccions
 * per poder executarles al algoritme de resoluci� de problemes
 * d'est�tica.
 * @author David
 */
public class SimulationStage extends GridStage{
	...
	/**
	 * Cont� la informaci� �nica d'una simulaci� no gr�fica, tota la part
	 * estrictament log�stica que podr� ser utilitzada en un �mbit no gr�fic
	 * @author David
	 */
	public static class Simulation{
		...
		/**
		 * Aplica les forces a la simulaci�
		 */
	...
	/**
	 * Inicialitza tots els objectes de Sandbox dins la simulaci� s
	 * @param s La simulaci� a carregar
	 * @param dynamicSimulation si es tracta de la simulaci� per a l'entorn gr�fic
	 */
	...
	/**
	 * Carrega les joints primeres a la simulaci� s
	 * @param s La simulaci� a carregar
	 * @param dynamicSimulation si es tracta de la simulaci� per a l'entorn gr�fic
	 */
	...
	/**
	 * Executa un step de la simulaci�
	 */
