...
/**
 * Versi� modificada de {@link ShapeRenderer} per poder renderitzar cercles tenint en compte
 * par�metres com el tamany del zoom apart del seu radi.
 * @author David
 *
 */
public class NShapeRenderer extends ShapeRenderer{
	...
	/**
	 * Calcula el nombre de segments optim en funci� del zoom del actual Escenari
	 * @param radius
