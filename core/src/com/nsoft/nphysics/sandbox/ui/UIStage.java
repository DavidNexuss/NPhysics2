 ...
 * que formen part de l'intef�cie d'usuari. A part tamb� es el punt central
 * del paquet destinat a la interf�cie d'usuari i node principal del que
 * tots els elements visuals no controlats per la camara estan afegits.
 * 
 * Gran part del codi d'aquesta classe es basa en construi tota la interf�cie
 * @author David
 */
public class UIStage extends Stage{
	...
	public UIStage() {
		...
		//	setDebugAll(true); //Funci� per debugueig
	...
	/**
	 * Afegeix els items del men� d'eines
	 */
	...
	/**
	 * Afegeix els items del segon submen� d'eines
	 */
	...
	/************************************************
	 * Funcions per mostrar i ocultar el men� global
	 **********************************************/
	...
	/**
	 * Actualitza tot l'esquema per una nova resoluci� de pantalla
	 */
